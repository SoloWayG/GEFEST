...
for iteration in range(10):
    for n, fig in enumerate(figure_names):
        ################################
        new_path = f'1508_Random_1_base_extra_{opt_params.c_rate}__exp_no_add_del_{LOSS}_p_size_{opt_params.pop_size}_n_stps_{opt_params.n_steps}_m_rate_{opt_params.m_rate}/iter{iteration}/{fig}_exp'     #path to create new dir of experement iteration
        ###############################
