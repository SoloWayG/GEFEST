...
paths_for_plotting = ['cases/sound_waves/experements/001_3107_roulette_top5_025extra_cross_normMSE_p_size_50_n_stps_200_m_rate_0.6/iter_0/bottom_square',
                      'cases/sound_waves/experements/001_3107_roulette_top5_025extra_cross_normMSE_p_size_50_n_stps_200_m_rate_0.5/iter_0/bottom_square',
                      'cases/sound_waves/experements/001_3107_roulette_top5_025extra_normMSE_p_size_50_n_stps_200_m_rate_0.9/iter_0/bottom_square',
                      'cases/sound_waves/experements/001_3107_tournament_top5_025extra_normMSE_p_size_50_n_stps_200_m_rate_0.9/iter_0/bottom_square',
                      'cases/sound_waves/experements/001_3107_tournament_top5_cross_025extra_normMSE_p_size_50_n_stps_200_m_rate_0.5/iter_0/bottom_square',
                      'cases/sound_waves/experements/001_3107_tournament_top5_cross_025extra_normMSE_p_size_50_n_stps_200_m_rate_0.6/iter_0/bottom_square',
                      'cases/sound_waves/experements/001_3107_roulette_top5_025extra_cross_normMSE_p_size_50_n_stps_200_m_rate_0.6/iter_1/bottom_square',
                      'cases/sound_waves/experements/001_3107_roulette_top5_025extra_cross_normMSE_p_size_50_n_stps_200_m_rate_0.5/iter_1/bottom_square',
                      'cases/sound_waves/experements/001_3107_roulette_top5_025extra_normMSE_p_size_50_n_stps_200_m_rate_0.9/iter_1/bottom_square',
                      'cases/sound_waves/experements/001_3107_tournament_top5_025extra_normMSE_p_size_50_n_stps_200_m_rate_0.9/iter_1/bottom_square',
                      'cases/sound_waves/experements/001_3107_tournament_top5_cross_025extra_normMSE_p_size_50_n_stps_200_m_rate_0.5/iter_1/bottom_square',
                      'cases/sound_waves/experements/2_0908_025extra_200dur_cross0.3__exp_no_add_del_MSE_p_size_50_n_stps_200_m_rate_0.6/iter1/bottom_square_exp',
                      'cases/sound_waves/experements/2_0908_025extra_200dur_cross0.3__exp_no_add_del_MSE_p_size_50_n_stps_200_m_rate_0.6/iter0/bottom_square_exp',
...
for i,dice_box_ in zip(boxs[49:200:50],boxs_dice[49:200:50]):
    ...
    #print('mean',[mean(n) for n in i],'+/-','max', [max(n) for n in i]-[mean(n) for n in i])
    ...
    best_dice_of_pop = [sum(np.array(i)>dice_critetia)/np.array(i).size for i in dice_box_]
    iter = 0
    ...
    for mean__, max__,dice__,min__ in zip(mean_, max_,best_dice_of_pop,min_):
        #dict_df[f'Itereation number is {50*(case_+1)}'][f'recivers {receverse[iter]}']=[]
        #dict_df[f'Itereation number is {50 * (case_ + 1)}'][f'Dice recivers {receverse[iter]}'] = []
        #dict_df[f'Itereation number is {50*(case_+1)}'][iter][f'recivers {receverse[iter]}']=[]
        #dict_df[f'Itereation number is {50*(case_+1)}'][iter][f'Dice recivers {receverse[iter]}'] = []
        print(f'Loss of {receverse[iter]}')
        print('Value is ', round(mean__,2), '+/-', round(max__ - mean__,2))
        print(f'% of Dice is more than {dice_critetia} =',dice__)
